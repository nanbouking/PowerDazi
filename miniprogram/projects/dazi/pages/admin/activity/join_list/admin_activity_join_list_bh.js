	...
	*/
		...
		bindCancelAllCmpt: async function () {
			try {
				...
				await cloudHelper.callCloudSumbit(this.data.route + '/activity_cancel_join_all', params, opt).then(res => {
					let callback = () => {
						wx.redirectTo({
		...
		bindCheckinTap: async function (e) {
			...
			let callback = async () => {
				...
				try {
					await cloudHelper.callCloudSumbit(this.data.route + '/activity_join_checkin', params, opts).then(res => {
						let cb = () => {
		...
		bindDelTap: async function (e) {
			...
			let callback = async () => {
				...
				try {
					await cloudHelper.callCloudSumbit(this.data.route + '/activity_join_del', params, opts).then(res => {
		...
		bindStatusTap: async function (e) {
			...
			let callback = async () => {
				...
				try {
					await cloudHelper.callCloudSumbit(this.data.route + '/activity_join_status', params, opts).then(res => {
