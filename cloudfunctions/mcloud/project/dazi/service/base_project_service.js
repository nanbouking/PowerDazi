		...
		if (await dbUtil.isExistCollection(F('activity'))) {
			...
			if (activityCnt == 0) {
				...
				for (let j in activityArr) {
					...
					data.ACTIVITY_START = this._timestamp + 86400 * 1000 * 30;
					data.ACTIVITY_END = this._timestamp + 86400 * 1000 * 60;
					data.ACTIVITY_STOP = this._timestamp + 86400 * 1000 * 60;
